  ...
  return (
    <div className="dashboard-container">
      ...
      <section className="categories">
       <Link to="/notes" className="category-card yellow">Notes</Link>
       <Link to="/students" className="category-card blue">Students</Link>
       <Link to="/attendence" className="category-card green">Attendance</Link>
       <Link to="/teachers" className="category-card orange">Teachers</Link>
       <Link to="/homework" className="category-card pink">Homeworks</Link>
       <Link to="/attendenceReport" className="category-card pink">Reports</Link>
      </section>
